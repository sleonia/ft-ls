...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/07/24 15:55:41 by samymone          #+#    #+#             */
/*   Updated: 2019/07/24 15:55:44 by samymone         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "ft_printf.h"

int							check_num2(signed long int d, t_struct *f)
{
	char					*extra_d;
...
void						ft_print_lld(t_struct *f, va_list ap)
{
	...
	d = va_arg(ap, signed long long int);
	if (check_num2(d, f))
		return ;
